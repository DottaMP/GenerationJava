...
public class Lutador {
	...
	public void apresentar(){
		...
		System.out.println("Diretamente da(do)(s) "+this.getNacionalidade());
	...
	private void setCategoria() {//ao chamar o setPeso, o peso será analisado dentro de categoria para mostrar a qual pertence.
		if (this.peso < 52.2){
